initSidebarItems({
  constant: [
    ...
    ['CODESET', ''],
    ['CONNECT_DATA_AUTHENTICATED', 'data includes security that replaces the TFO-cookie'],
    ['CONNECT_DATA_IDEMPOTENT', 'data is idempotent'],
    ['CONNECT_RESUME_ON_READ_WRITE', 'resume connect() on read/write'],
    ['CR0', ''],
    ['CR1', ''],
    ['CR2', ''],
    ['CR3', ''],
    ...
    ['IPPROTO_DONE', 'last return value of *_input(), meaning "all job for this pkt is done".'],
    ...
    ['IPPROTO_GGP', 'gateway2 (deprecated)'],
    ['IPPROTO_GMTP', 'GMTP'],
    ...
    ['IPPROTO_ND', 'Sun net disk proto (temp.)'],
    ...
    ['IPPROTO_SATEXPAK', 'SATNET/Backroom EXPAK'],
    ...
    ['IPPROTO_TCF', 'TCF'],
    ['IPPROTO_TCP', ''],
    ['IPPROTO_TP', 'tp-4 w/ class negotiation'],
    ...
    ['TCOOFF', ''],
    ['TCOON', ''],
    ['TCP_FASTOPEN', 'Enable/Disable TCP Fastopen on this socket'],
    ['TCP_KEEPALIVE', ''],
    ['TCP_MAXSEG', ''],
    ['TCP_NODELAY', ''],
    ['TCP_NOOPT', ''],
